...
def getHigh(base):
    move_horizontal(base, 0.014, 0.221)
    move_vertical(base, 0.434, 0.042)
    move_forward(base, 0.575, 0.786)
    return True    
...
def ayedrop(base, zoneNum, sX,sY, sZ):
    ...
    if(zoneNum == 1):
        ...
        move_forward(base, sX, 0.349)
        move_horizontal(base, sY, 0.486)
        full = True
