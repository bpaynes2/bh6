...
def getNoods(base):
    move_vertical(base, 0.434, 0.0256)
    move_horizontal(base, 0.114, 0.428)
    move_forward(base, -0.575, -0.306)
    return True
...
def ayedrop(base, zoneNum, sX,sY, sZ):
    #full = False
    if(zoneNum == 1):
        move_horizontal(base, sY,-0.1)
        move_forward(base, sX, 0.540)
        move_vertical(base, sZ, 0.9954)
        move_forward(base, sX, 0.540)
